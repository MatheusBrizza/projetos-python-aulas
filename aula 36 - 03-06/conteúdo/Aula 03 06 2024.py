            ...
            def Text_explicacao():
                ...
                def exemplo_Text_func1():
                    def contar_caracteres():
                        ...
                        numero_caracteres = len(texto) - 1 # o -1 serve pq a contagem começa no 1 ao invés de 0, então para ter a contagem certa tiramos o primero caracter que não existe
