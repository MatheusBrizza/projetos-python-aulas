...
listaNumerica = []#Pode usar somente um conjunto ao invés de usar uma lista. listaNumerica = set()
while True: 
...
while True:
    ...
    if numeros == tecla_parada and listaNumerica != []:
        ...
        continue
    numeros = int(numeros)
    listaNumerica.append(numeros)#Adiciona o número ao conjunto listaNumerica.add(numeros)
...
#Explore novas formas de controle.